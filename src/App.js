...
function App() {
  ...
  const handleClick = (e) => {
    ...
    if (
      ...
      console.log("files, REACT_APP_UPLOAD_ENDPOINT", input.files, files, process.env.REACT_APP_UPLOAD_ENDPOINT );
...
<option value="KAILASA TRISHULAM">KAILASA TRISHULAM</option>
<option value="KAILASA TANJAVUR">KAILASA TANJAVUR</option>
<option value="KAILASA HOSUR">KAILASA HOSUR</option>
<option value="KAILASA HARIDWAR">KAILASA HARIDWAR</option>
<option value="KAILASA PONDICHERRY">KAILASA PONDICHERRY</option>
...
<option value="KAILASA KASHI">KAILASA KASHI</option>
<option value="KAILASA ICHAPURAM">KAILASA ICHAPURAM</option>
<option value="KAILASA TRINIDAD & TOBAGO">KAILASA TRINIDAD &amp; TOBAGO</option>
<option value="KAILASA ORAGADAM">KAILASA ORAGADAM</option>
<option value="KAILASA THIRUCHENGODE">KAILASA THIRUCHENGODE</option>
<option value="KAILASA VADODARA">KAILASA VADODARA</option>
<option value="KAILASA KOZHIKODE">KAILASA KOZHIKODE</option>
...
<option value="KAILASA SAN DIEGO">KAILASA SAN DIEGO</option>
<option value="KAILASA SWITZERLAND">KAILASA SWITZERLAND</option>
<option value="KAILASA GAMBIA, WEST AFRICA">KAILASA GAMBIA, WEST AFRICA</option>
<option value="KAILASA UTTARAHALLI">KAILASA UTTARAHALLI</option>
...
<option value="KAILASA ARACAJU-SE NORDESTE, BRASIL">KAILASA ARACAJU-SE NORDESTE, BRASIL</option>
<option value="KAILASA ARAUCARIA - PARANA, BRASIL">KAILASA ARAUCARIA - PARANA, BRASIL</option>
...
<option value="KAILASA BAHIA SAO PAULO BRASIL">KAILASA BAHIA SAO PAULO BRASIL</option>
...
<option value="KAILASA BANDRA MUMBAI, INDIA">KAILASA BANDRA MUMBAI, INDIA</option>
<option value="KAILASA BANDRA, INDIA">KAILASA BANDRA, INDIA</option>
<option value="KAILASA BARCELONA ESPANA">KAILASA BARCELONA ESPANA</option>
<option value="KAILASA BARRACKPORE, TRINIDAD & TOBAGO">KAILASA BARRACKPORE, TRINIDAD & TOBAGO</option>
<option value="KAILASA BASAVANAGUDI BANGALORE, INDIA">KAILASA BASAVANAGUDI BANGALORE, INDIA</option>
<option value="KAILASA BAUDHA, NEPAL">KAILASA BAUDHA, NEPAL</option>
<option value="KAILASA BAURU SP, BRASIL">KAILASA BAURU SP, BRASIL</option>
<option value="KAILASA BELGIUM">KAILASA BELGIUM</option>
<option value="KAILASA BHANASHANKARI, INDIA">KAILASA BHANASHANKARI, INDIA</option>
<option value="KAILASA BOTAFOGO, RIO DE JANEIRO BRASIL">KAILASA BOTAFOGO, RIO DE JANEIRO BRASIL</option>
<option value="KAILASA BRATISLAVA, SLOVAKIA">KAILASA BRATISLAVA, SLOVAKIA</option>
<option value="KAILASA BRNO, CZECH REPUBLIC">KAILASA BRNO, CZECH REPUBLIC</option>
<option value="KAILASA CALGARY, CANADA">KAILASA CALGARY, CANADA</option>
<option value="KAILASA CASANARE VILLANUEVA, COLOMBIA">KAILASA CASANARE VILLANUEVA, COLOMBIA</option>
<option value="KAILASA CHAPALA MEXICO">KAILASA CHAPALA MEXICO</option>
<option value="KAILASA CHARLOTTE, USA">KAILASA CHARLOTTE, USA</option>
<option value="KAILASA CHRISTCHURCH, NZ">KAILASA CHRISTCHURCH, NZ</option>
<option value="KAILASA CIUDAD AUTONOMA DE BUENOS AIRES, ARGENTINA">KAILASA CIUDAD AUTONOMA DE BUENOS AIRES, ARGENTINA</option>
<option value="KAILASA CIUDAD DE MEXICO, MEXICO">KAILASA CIUDAD DE MEXICO, MEXICO</option>
<option value="KAILASA COAHULIA, SALTILLO, MEXICO">KAILASA COAHULIA, SALTILLO, MEXICO</option>
<option value="KAILASA COMPASSVALE, SINGAPORE">KAILASA COMPASSVALE, SINGAPORE</option>
<option value="KAILASA CONNECTICUT, USA">KAILASA CONNECTICUT, USA</option>
<option value="KAILASA COSTA VERDE, BRASIL">KAILASA COSTA VERDE, BRASIL</option>
<option value="KAILASA CROATIA">KAILASA CROATIA</option>
<option value="KAILASA CURITIBA-LESTE, BRASIL">KAILASA CURITIBA-LESTE, BRASIL</option>
<option value="KAILASA DALLAS, USA">KAILASA DALLAS, USA</option>
<option value="KAILASA DANVILLE CALIFORNIA, USA">KAILASA DANVILLE CALIFORNIA, USA</option>
<option value="KAILASA DHUMBARAI, NEPAL">KAILASA DHUMBARAI, NEPAL</option>
<option value="KAILASA DUBAI">KAILASA DUBAI</option>
<option value="KAILASA EL SALADO VENEZUELA">KAILASA EL SALADO VENEZUELA</option>
<option value="KAILASA ESPANOL en LAS VEGAS, USA">KAILASA ESPANOL en LAS VEGAS, USA</option>
<option value="KAILASA ESSEX, UK">KAILASA ESSEX, UK</option>
<option value="KAILASA FAMILIA PORTUGUESA, PORTUGAL">KAILASA FAMILIA PORTUGUESA, PORTUGAL</option>
<option value="KAILASA GAROPABA SANTA CATARINA, BRASIL">KAILASA GAROPABA SANTA CATARINA, BRASIL</option>
<option value="KAILASA GAUTENG, SOUTH AFRICA">KAILASA GAUTENG, SOUTH AFRICA</option>
<option value="KAILASA GENOVA, ITALY">KAILASA GENOVA, ITALY</option>
<option value="KAILASA GOIANIA GOIAS BRASIL">KAILASA GOIANIA GOIAS BRASIL</option>
<option value="KAILASA GOIANIA, CITY IN BRASIL">KAILASA GOIANIA, CITY IN BRASIL</option>
<option value="KAILASA GOTHENBURG, SWEDEN">KAILASA GOTHENBURG, SWEDEN</option>
<option value="KAILASA GOYAVE, GUADELOUPE">KAILASA GOYAVE, GUADELOUPE</option>
<option value="KAILASA GRASSE, FRANCE">KAILASA GRASSE, FRANCE</option>
<option value="KAILASA GUAYAQUILL, ECUADOR">KAILASA GUAYAQUILL, ECUADOR</option>
<option value="KAILASA GUPTAKASHI, HYDERABAD">KAILASA GUPTAKASHI, HYDERABAD</option>
<option value="KAILASA HOUSTON, USA">KAILASA HOUSTON, USA</option>
<option value="KAILASA HUNTERSVILLE, USA">KAILASA HUNTERSVILLE, USA</option>
<option value="KAILASA HYDERABAD, INDIA">KAILASA HYDERABAD, INDIA</option>
<option value="KAILASA INDIANAPOLIS, USA">KAILASA INDIANAPOLIS, USA</option>
<option value="KAILASA INDRANAGAR BANGALORE, INDIA">KAILASA INDRANAGAR BANGALORE, INDIA</option>
<option value="KAILASA IPIRANGA SAO PAULO BRASIL">KAILASA IPIRANGA SAO PAULO BRASIL</option>
<option value="KAILASA IRAQ">KAILASA IRAQ</option>
<option value="KAILASA ITAJAI SC SANTA CATARINA, BRASIL">KAILASA ITAJAI SC SANTA CATARINA, BRASIL</option>
<option value="KAILASA JERSEY CITY, USA">KAILASA JERSEY CITY, USA</option>
<option value="KAILASA JOHN'S CREEK GEORGIA, USA">KAILASA JOHN'S CREEK GEORGIA, USA</option>
<option value="KAILASA JORPATI, NEPAL">KAILASA JORPATI, NEPAL</option>
<option value="KAILASA JUTLAND, DENMARK">KAILASA JUTLAND, DENMARK</option>
<option value="KAILASA KANNUR, INDIA">KAILASA KANNUR, INDIA</option>
<option value="KAILASA KASAVANAHALLI BANGALORE, INDIA">KAILASA KASAVANAHALLI BANGALORE, INDIA</option>
<option value="KAILASA KENT, UK">KAILASA KENT, UK</option>
<option value="KAILASA KILAMBA KIAXI, LUANDA ANGOLA, AFRICA IN PORTUGUES">KAILASA KILAMBA KIAXI, LUANDA ANGOLA, AFRICA IN PORTUGUES</option>
<option value="KAILASA KOSICE, SLOVAKIA">KAILASA KOSICE, SLOVAKIA</option>
<option value="KAILASA KOZHIKODE, INDIA">KAILASA KOZHIKODE, INDIA</option>
<option value="KAILASA KUALA LUMPUR, MALAYSIA">KAILASA KUALA LUMPUR, MALAYSIA</option>
<option value="KAILASA KULIM, MALAYSIA">KAILASA KULIM, MALAYSIA</option>
<option value="KAILASA LAMENTIN, GUADELOUPE">KAILASA LAMENTIN, GUADELOUPE</option>
<option value="KAILASA LATIN AMERICA">KAILASA LATIN AMERICA</option>
<option value="KAILASA LATIN AMERICA YATRA, USA">KAILASA LATIN AMERICA YATRA, USA</option>
<option value="KAILASA LE GOSIER, GUADELOUPE">KAILASA LE GOSIER, GUADELOUPE</option>
<option value="KAILASA LEBANON">KAILASA LEBANON</option>
<option value="KAILASA LONG ISLAND CITY, NEW YORK, USA">KAILASA LONG ISLAND CITY, NEW YORK, USA</option>
<option value="KAILASA LONG ISLAND CITY, USA">KAILASA LONG ISLAND CITY, USA</option>
<option value="KAILASA LOS ANGELES ESPANOL, USA">KAILASA LOS ANGELES ESPANOL, USA</option>
...
<option value="KAILASA MACAPA- AMAPA, BRAZIL">KAILASA MACAPA- AMAPA, BRAZIL</option>
<option value="KAILASA MADRID ESPANA">KAILASA MADRID ESPANA</option>
<option value="KAILASA MASSACHUSSETTS, USA">KAILASA MASSACHUSSETTS, USA</option>
...
<option value="KAILASA MERCED CALIFORNIA, USA">KAILASA MERCED CALIFORNIA, USA</option>
<option value="KAILASA MIAMI, USA">KAILASA MIAMI, USA</option>
<option value="KAILASA MICHIGAN, USA">KAILASA MICHIGAN, USA</option>
<option value="KAILASA MOGI DAS CRUZES SP, BRASIL">KAILASA MOGI DAS CRUZES SP, BRASIL</option>
<option value="KAILASA MONTES CLAROS, BRASIL">KAILASA MONTES CLAROS, BRASIL</option>
<option value="KAILASA MULHEIM, GERMANY">KAILASA MULHEIM, GERMANY</option>
<option value="KAILASA MUSCAT">KAILASA MUSCAT</option>
<option value="KAILASA NAGPUR, INDIA">KAILASA NAGPUR, INDIA</option>
<option value="KAILASA NANTES, FRANCE">KAILASA NANTES, FRANCE</option>
<option value="KAILASA NAPIER, NZ">KAILASA NAPIER, NZ</option>
<option value="KAILASA NAUCALPAN, ESTADO DE MEXICO, MEXICO">KAILASA NAUCALPAN, ESTADO DE MEXICO, MEXICO</option>
<option value="KAILASA NAVI MUMBAI, INDIA">KAILASA NAVI MUMBAI, INDIA</option>
<option value="KAILASA NAYANAPANAHALLI BANGALORE, INDIA">KAILASA NAYANAPANAHALLI BANGALORE, INDIA</option>
<option value="KAILASA NEW HYDE PARK, NEW YORK, USA">KAILASA NEW HYDE PARK, NEW YORK, USA</option>
<option value="KAILASA NEW HYDE PARK, USA">KAILASA NEW HYDE PARK, USA</option>
<option value="KAILASA NEW JERSEY, USA">KAILASA NEW JERSEY, USA</option>
<option value="KAILASA NEW YORK, USA">KAILASA NEW YORK, USA</option>
<option value="KAILASA NORTH LONDON, UK">KAILASA NORTH LONDON, UK</option>
<option value="KAILASA NOVENA, SINGAPORE">KAILASA NOVENA, SINGAPORE</option>
...
<option value="KAILASA ORANJESTAD, ARUBA, CARIBBEAN">KAILASA ORANJESTAD, ARUBA, CARIBBEAN</option>
<option value="KAILASA PHILADELPHIA, USA">KAILASA PHILADELPHIA, USA</option>
<option value="KAILASA PITTSBURGH, USA">KAILASA PITTSBURGH, USA</option>
<option value="KAILASA PLZEN, CZECH REPUBLIC">KAILASA PLZEN, CZECH REPUBLIC</option>
<option value="KAILASA PONCA CITY, USA">KAILASA PONCA CITY, USA</option>
<option value="KAILASA POPRAD, SLOVAKIA">KAILASA POPRAD, SLOVAKIA</option>
<option value="KAILASA POVAZSKA BYSTRICA, SLOVAKIA">KAILASA POVAZSKA BYSTRICA, SLOVAKIA</option>
<option value="KAILASA PRAGUE, CZECH REPUBLIC">KAILASA PRAGUE, CZECH REPUBLIC</option>
<option value="KAILASA PRAIA GRANDE, BRASIL">KAILASA PRAIA GRANDE, BRASIL</option>
<option value="KAILASA PRESIDENTE PRUDENTE SP, BRASIL">KAILASA PRESIDENTE PRUDENTE SP, BRASIL</option>
<option value="KAILASA PUGLIA, ITALY">KAILASA PUGLIA, ITALY</option>
<option value="KAILASA PUNE, INDIA">KAILASA PUNE, INDIA</option>
<option value="KAILASA QUEENS NEW YORK, USA">KAILASA QUEENS NEW YORK, USA</option>
<option value="KAILASA RANCAGUA, CHILE">KAILASA RANCAGUA, CHILE</option>
<option value="KAILASA RAVINE DES CABRIS REUNION ISLAND, FRANCE">KAILASA RAVINE DES CABRIS REUNION ISLAND, FRANCE</option>
<option value="KAILASA RESERVA NATURAL DE, MEXICO">KAILASA RESERVA NATURAL DE, MEXICO</option>
<option value="KAILASA RIO DE JANEIRO NORTE RICHUELO CENTRO, BRASIL">KAILASA RIO DE JANEIRO NORTE RICHUELO CENTRO, BRASIL</option>
<option value="KAILASA RIO GRANDE DO SUL, BRAZIL">KAILASA RIO GRANDE DO SUL, BRAZIL</option>
<option value="KAILASA ROMANIA">KAILASA ROMANIA</option>
<option value="KAILASA ROTORUA, NZ">KAILASA ROTORUA, NZ</option>
<option value="KAILASA SAN ANTONIO TEXAS, USA">KAILASA SAN ANTONIO TEXAS, USA</option>
<option value="KAILASA SAN DIEGO, USA">KAILASA SAN DIEGO, USA</option>
<option value="KAILASA SAN FERNANDO, TRINIDAD & TOBAGO">KAILASA SAN FERNANDO, TRINIDAD & TOBAGO</option>
<option value="KAILASA SAN JOSE, USA">KAILASA SAN JOSE, USA</option>
<option value="KAILASA SAN MIGUEL NICOLAS, MEXICO">KAILASA SAN MIGUEL NICOLAS, MEXICO</option>
<option value="KAILASA SANTA MARIA, BRAZIL">KAILASA SANTA MARIA, BRAZIL</option>
<option value="KAILASA SANTA ROSA DE VITERBO, BRASIL">KAILASA SANTA ROSA DE VITERBO, BRASIL</option>
<option value="KAILASA SANTOS PRAIA SAO PAULO, BRASIL">KAILASA SANTOS PRAIA SAO PAULO, BRASIL</option>
<option value="KAILASA SAO PAULO A CAPITAL, BRASIL">KAILASA SAO PAULO A CAPITAL, BRASIL</option>
<option value="KAILASA SAO PAULO BRASIL">KAILASA SAO PAULO BRASIL</option>
<option value="KAILASA SAO PAULO, SANTOS, BRASIL">KAILASA SAO PAULO, SANTOS, BRASIL</option>
<option value="KAILASA SC AMERICANA / SAO PAULO BRASIL">KAILASA SC AMERICANA / SAO PAULO BRASIL</option>
<option value="KAILASA SC BARREIRAS BA, BRASIL">KAILASA SC BARREIRAS BA, BRASIL</option>
<option value="KAILASA SC IPATINGA MG BRASIL">KAILASA SC IPATINGA MG BRASIL</option>
<option value="KAILASA SCOTLAND UNITED KINGDOM">KAILASA SCOTLAND UNITED KINGDOM</option>
<option value="KAILASA SCOTLAND, UNITED KINGDOM">KAILASA SCOTLAND, UNITED KINGDOM</option>
...
<option value="KAILASA SEREMBAN, MALAYSIA">KAILASA SEREMBAN, MALAYSIA</option>
<option value="KAILASA SERGIPE, BRAZIL">KAILASA SERGIPE, BRAZIL</option>
<option value="KAILASA SINGAPORE">KAILASA SINGAPORE</option>
<option value="KAILASA SINTRA PORTUGAL">KAILASA SINTRA PORTUGAL</option>
<option value="KAILASA SION, INDIA">KAILASA SION, INDIA</option>
<option value="KAILASA SOUTH AUCKLAND NZ">KAILASA SOUTH AUCKLAND NZ</option>
<option value="KAILASA ST. LOUIS, USA">KAILASA ST. LOUIS, USA</option>
<option value="KAILASA SUVA, FIJI">KAILASA SUVA, FIJI</option>
<option value="KAILASA SYDNEY, AUSTRALIA">KAILASA SYDNEY, AUSTRALIA</option>
<option value="KAILASA TENERIFE, ESPANA">KAILASA TENERIFE, ESPANA</option>
<option value="KAILASA TERESINA, PIAUI, BRASIL">KAILASA TERESINA, PIAUI, BRASIL</option>
<option value="KAILASA THANE, INDIA">KAILASA THANE, INDIA</option>
<option value="KAILASA THE HAGUE, NETHERLANDS">KAILASA THE HAGUE, NETHERLANDS</option>
<option value="KAILASA TORONTO, CANADA">KAILASA TORONTO, CANADA</option>
<option value="KAILASA TUMKUR, INDIA">KAILASA TUMKUR, INDIA</option>
<option value="KAILASA TURKEY">KAILASA TURKEY</option>
<option value="KAILASA UAE">KAILASA UAE</option>
<option value="KAILASA UNITED KINGDOM">KAILASA UNITED KINGDOM</option>
<option value="KAILASA UTRECHT, NETHERLANDS">KAILASA UTRECHT, NETHERLANDS</option>
<option value="KAILASA VADODARA, INDIA">KAILASA VADODARA, INDIA</option>
<option value="KAILASA VALAIS, CH">KAILASA VALAIS, CH</option>
<option value="KAILASA VALASSKE MEZIRICI, CZECH REPUBLIC">KAILASA VALASSKE MEZIRICI, CZECH REPUBLIC</option>
<option value="KAILASA VALLE DEL CAUCA, COLOMBIA">KAILASA VALLE DEL CAUCA, COLOMBIA</option>
<option value="KAILASA VALPARAISO, CHILE">KAILASA VALPARAISO, CHILE</option>
<option value="KAILASA VANCOUVER, USA">KAILASA VANCOUVER, USA</option>
<option value="KAILASA VARC, INDIA">KAILASA VARC, INDIA</option>
<option value="KAILASA VILLENEUVE, FRANCE">KAILASA VILLENEUVE, FRANCE</option>
<option value="KAILASA VOGHERA, ITALY">KAILASA VOGHERA, ITALY</option>
<option value="KAILASA WELLINGTON, NZ">KAILASA WELLINGTON, NZ</option>
<option value="KAILASA WICIEJOW, POLAND">KAILASA WICIEJOW, POLAND</option>
<option value="KAILASA YSTAD, SWEDEN">KAILASA YSTAD, SWEDEN</option>
<option value="KAILASA ZURICH, SWITZERLAND">KAILASA ZURICH, SWITZERLAND</option>
<option value="OTHER - I DO NOT BELONG TO ANY KAILASA">OTHER - I DO NOT BELONG TO ANY KAILASA</option>
<option value="OTHER - MY KAILASA IS NOT IN THIS LIST">OTHER - MY KAILASA IS NOT IN THIS LIST</option>
<option value="KASHI SARVAJNAPEETAM">KASHI SARVAJNAPEETAM</option>
<option value="SHYAMALAPEETA SARVAJNAPEETAM">SHYAMALAPEETA SARVAJNAPEETAM</option>
<option value="SURYA VAMSA SURANGI SAMRAJYA SARVAJNAPEETAM">SURYA VAMSA SURANGI SAMRAJYA SARVAJNAPEETAM</option>
